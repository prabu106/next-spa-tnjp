...
function ContactHero() {
    return (
        <section className="relative overflow-hidden bg-[url('/contact.png')] bg-cover bg-center overflow-hidden bg-[linear-gradient(115deg,#123f82_0%,#0f3b7a_43%,#1a4f98_100%)]">
                    ...
                    <form className="mt-6 space-y-4" noValidate onSubmit={handleSubmit}>
                        ...
                        <div>
                            <textarea
                                ...
                                onChange={handleChange}
                                className={`w-full rounded-md border bg-white px-4 py-4 text-base text-[#243250] outline-none transition placeholder:text-[#7d8aa8] focus:border-[#2a5cac] ${errors.message ? "border-[#de3f32]" : "border-[#d5deeb]"
                                    }`}
                            />
                            {errors.message ? (
                        ...
                        {submitMessage ? (
                            <p
                                className={`text-sm font-semibold ${Object.keys(errors).length > 0 ? "text-[#de3f32]" : "text-[#1e7a43]"
                                    }`}
                            >
                                {submitMessage}
                            </p>
                ...
                <div className="grid gap-8 lg:grid-cols-[0.72fr_1.28fr]">
                    ...
                    <div className="relative min-h-[320px] overflow-hidden rounded-2xl border border-[#dce3ef] bg-[linear-gradient(180deg,#fbfdff_0%,#f1f6fb_100%)] shadow-[0_14px_30px_rgba(19,44,94,0.08)]">
                        ...
                        <div className="absolute left-[52%] top-[46%] flex -translate-x-1/2 -translate-y-1/2 items-center gap-3">
                            <MapPinMarker />
                            <span className="text-xl font-bold text-[#de3521]">X X X</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    return (
        <div>
            <input
                ...
                className={`w-full rounded-md border bg-white px-4 py-4 text-base text-[#243250] outline-none transition placeholder:text-[#7d8aa8] focus:border-[#2a5cac] ${error ? "border-[#de3f32]" : "border-[#d5deeb]"
                    }`}
            />
